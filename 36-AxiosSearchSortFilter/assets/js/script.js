...
//   searchInput.parentElement.appendChild(suggestionList); // Append suggestions below the input

//   // Function to render products
//   function renderProducts(productsToRender) {
//     document.querySelector(".cards").innerHTML = "";
//     createUserCard(productsToRender);
//   }
...
//     if (searchvalue) {
//       let suggestions = filteredProducts.slice(0, 3); // Get top 3 products
//       suggestions.forEach((product) => {
//         let suggestionItem = document.createElement("li");
//         suggestionItem.textContent = product.title;
//         suggestionItem.addEventListener("click", () => {
//           searchInput.value = product.title; // Set the input value to the clicked suggestion
//           applySearch(); // Call applySearch to render products based on the selected suggestion
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  function applySearch() {
    ...
    if (searchvalue) {
      ...
      // Show the suggestion list if there are suggestions
      suggestionList.style.display = suggestions.length > 0 ? "block" : "none";
    } else {
      suggestionList.style.display = "none"; // Hide suggestions if search value is empty
    }
  }
